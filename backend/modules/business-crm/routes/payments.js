...
router.get('/client-pending', requirePermission('clients.view'), asyncHandler(async (req, res) => res.json(await payments.listOutstanding('client', req.query))));
router.get('/vendor-dues', requirePermission('vendors.view'), asyncHandler(async (req, res) => res.json(await payments.listOutstanding('vendor', req.query))));
