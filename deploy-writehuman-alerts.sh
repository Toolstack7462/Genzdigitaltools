...
exec bash deploy-backend.sh backend/routes/admin/proxyTools.js backend/utils/proxy/healthAlerts.js backend/utils/proxy/deviceSync.js backend/utils/proxy/candidateSync.js
