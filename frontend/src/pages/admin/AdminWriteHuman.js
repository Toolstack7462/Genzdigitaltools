          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            <Panel icon={Zap} title="Actions" tint="text-cyan-500">
              ...
              <div className="flex flex-wrap gap-2">
                <button disabled={!!busy || conn !== 'live'} onClick={() => act(writeHumanV2Admin.verify, 'Verify triggered')} className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg text-[13px] font-semibold text-white bg-gradient-to-r from-blue-600 to-cyan-500 disabled:opacity-50"><CheckCircle2 size={15} /> Verify now</button>
