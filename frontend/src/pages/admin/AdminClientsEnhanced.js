  ...
  return (
    <AdminLayoutEnhanced>
      <div className="max-w-7xl mx-auto space-y-6" data-testid="admin-clients-page">
        ...
        {/* Clients Grid */}
        {loading ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6" aria-busy="true" aria-label="Loading clients">
                  ...
                  <div className="relative p-6">
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-2">
                      ...
                      <button
                        ...
                        className="flex items-center justify-center gap-2 px-3 py-2.5 bg-genz-teal/15 text-genz-teal rounded-xl hover:bg-genz-teal/25 transition-colors text-sm font-medium"
                      >
                        <LogOut size={14} />
