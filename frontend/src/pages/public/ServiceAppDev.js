...
const APP_TYPES = [
  ...
  { icon: Cpu,        color: '#00AFC1', title: 'Client Portals',      desc: 'Secure client-facing portals for project tracking, file sharing, and communication.' },
    ...
    <div style={{ background: '#000820' }} className="overflow-x-hidden">
      ...
      <section className="py-16 px-4">
        <div ref={processRef} className={`max-w-3xl mx-auto reveal ${processVisible ? 'visible' : ''}`}>
          <h2 className="text-2xl font-bold text-white text-center mb-10">Our development process</h2>
