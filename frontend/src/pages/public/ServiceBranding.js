...
const BRAND_TYPES = [
  ...
  { icon: Image,     color: '#00AFC1', title: 'Content Creatives',       desc: 'Ad creatives, promotional banners, digital marketing visual assets.' },
];
    ...
    <div style={{ background: '#000820' }} className="overflow-x-hidden">
      ...
      <section className="py-20 px-4">
        <div ref={typesRef} className={`max-w-6xl mx-auto reveal ${typesVisible ? 'visible' : ''}`}>
          <h2 className="text-2xl sm:text-3xl font-bold text-white text-center mb-12">Design services</h2>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto rounded-3xl p-8" style={{ background: 'rgba(249,115,22,0.06)', border: '1px solid rgba(249,115,22,0.18)' }}>
          <h3 className="text-white font-bold text-xl mb-6 text-center">What every design project includes</h3>
