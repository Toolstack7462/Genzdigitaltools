...
const ChromeExtensionPage = () => {
  return (
    <div className="min-h-screen px-4 py-10" style={{ background: 'linear-gradient(135deg, #000820, #001030)' }}>
      <div className="max-w-4xl mx-auto">
        <Link to="/client/dashboard" className="inline-flex items-center gap-2 text-genz-muted hover:text-white mb-8">
          <ArrowLeft size={18} /> Back to Dashboard
        </Link>
        <div className="text-center mb-10">
          <GenZDigitalStoreLogo className="h-16 justify-center mb-6" />
          <h1 className="text-4xl font-black text-white mb-3">Gen Z Digital Store Chrome Extension</h1>
        ...
        <div className="rounded-2xl border p-8 mb-8" style={{ background: 'rgba(0,175,193,0.05)', borderColor: 'rgba(0,175,193,0.15)' }}>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">Download Extension</h2>
              <p className="text-genz-muted">Use this ZIP for manual Chrome installation.</p>
            </div>
          </div>
          <a href="/downloads/genz-digital-store-extension.zip" download className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl font-bold text-genz-deep-navy hover:opacity-90 transition-all" style={{ background: 'linear-gradient(135deg, #00AFC1, #008EA3)' }}>
            <Download size={20} /> Download Chrome Extension ZIP
          </a>
        </div>
        <div className="rounded-2xl border p-8" style={{ background: 'rgba(255,255,255,0.03)', borderColor: 'rgba(0,175,193,0.12)' }}>
