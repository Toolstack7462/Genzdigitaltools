          ...
          <div className="relative overflow-hidden rounded-2xl px-4 sm:px-5 py-4"
            ...
            <div className="relative z-10 flex flex-col xl:flex-row xl:items-center gap-3.5">
              ...
              <div className="flex-shrink-0 xl:self-center flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                ...
                {/* Secondary action: the same Setup Guide page and its existing video
                    embed. Given real contrast so it reads as a video link beside the
                    primary Install button, which it must not outrank. Opens only on
                    click - nothing here autoplays or pops up.
                ...
                <Link to="/client/extension-guide"
                  ...
                  <span>Watch Extension Video</span>
                  <span className="inline-flex items-center px-1.5 py-[2px] rounded-md text-[9.5px] font-bold uppercase tracking-wide leading-none flex-shrink-0"
                        style={{ background: 'rgba(255,255,255,0.14)', border: '1px solid rgba(255,255,255,0.30)', color: '#E8F7FB' }}>
                    Video Guide
                  </span>
                </Link>
              </div>
