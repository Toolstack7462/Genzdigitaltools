  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-20">
      <div className="max-w-lg w-full text-center">
        ...
        <h1 className="text-3xl font-black text-genz-navy mb-3">Welcome Back</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Link to="/client/login"
            ...
            <h3 className="font-bold text-genz-navy mb-1">Member Portal</h3>
          ...
          <Link to="/admin/login"
            ...
            <h3 className="font-bold text-genz-navy mb-1">Admin Panel</h3>
