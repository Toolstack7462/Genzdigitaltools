...
const SHOWCASE_ITEMS = [
  {
    ...
    tag: 'Dashboard UI',
    description: 'Multi-tool client dashboard with real-time tool usage chart, assigned-tool grid and secure session indicators.',
    accent: '#06B6D4',
  ...
  },
  {
    ...
    tag: 'Platform',
    description: 'A unified 90+ tools marketplace — admin-assigned access, category filters, and live extension-bridge status.',
    accent: '#14B8A6',
    tags: ['Full-Stack', 'Extension', 'Auth', 'CRM'],
  ...
  },
  {
    ...
    tag: 'Extension',
    description: 'Secure tool access via a Chrome MV3 extension — popup, connection status and one-click tool launch UX.',
    accent: '#06B6D4',
    tags: ['Chrome MV3', 'Security', 'Workflow'],
    Mock: ExtensionMock,
    ctaLabel: 'Explore Work',
  },
  {
