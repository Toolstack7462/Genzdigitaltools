...
const AdminWriteHumanAuthorize = lazy(() => import('./pages/admin/AdminWriteHumanAuthorize'));
      ...
      <div className="App min-h-screen" style={{ background: 'var(--brand-soft)' }}>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/admin/writehuman/agent-authorize" element={<ErrorBoundary><AdminRoute><AdminWriteHumanAuthorize /></AdminRoute></ErrorBoundary>} />
