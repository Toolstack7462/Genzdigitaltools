...
exec bash deploy-backend.sh backend/routes/proxy/agentSync.js backend/routes/admin/proxyTools.js backend/utils/proxy/deviceSync.js backend/utils/proxy/candidateSync.js backend/utils/proxy/agentEnroll.js backend/utils/proxy/sessionHealth.js
